...
public class IntroGenerator extends Generator {
    ...
    public void generateEntities() {
        ...
        trash = new SpaceTrash(Constants.SPACE_TRASH_1);
        trash.spawn(new Vector2f(-200, 200), new Vector2f(b_s * -4.5f, 0), Prototyp.frontground);


        trash = new SpaceTrash(Constants.SPACE_TRASH_4);
        trash.flipYAxis();
